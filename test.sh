#!/bin/bash
HOST=${HOST:-"127.0.0.1:5000/v1/auth/processes/A9893a41fc7046d66d39fdc073ed901af6bec66ecc070a97f9cb2dda02b11265"}
...
echo "=> Shared key"
R="$(curl -s $HOST/sharedkey -X POST -d '{"authData":[]}' | jq -Mc .sharedkey)"
[ "$R" == "" ] && { echo "Error receiving shared key"; exit 1; }
echo "sharedkey: $R"